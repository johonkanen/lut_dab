...
__interrupt void PWM1_int(void)
{
	...
	else
	{
		...
		if(duty1<duty2)
		{
			...
			*phase_reg.s1_phase = 449*duty2+449*duty2*phase;
			*phase_reg.s2_phase = 0+449*duty2*phase;
		}
		else
		{
			*phase_reg.p1_phase = 449*duty1+ 449*duty1*phase;
			*phase_reg.p2_phase = 0+ 449*duty1*phase;
